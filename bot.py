...
RULES_TEXT = (
    ...
    "Никакого токсика, оскорблений и наездов. f90d\n\n"
    "2️⃣ *Спорные темы — без срачей*\n"
    "Обсуждать можно что угодно, но уважайте чужую точку зрения. "
    "Если дискуссия переходит в срач — адмы остановят.\n\n"
    "3️⃣ *TW / Спойлер*\n"
    "Если поднимаешь потенциально триггерную или очень спорную тему — "
    "прячь под спойлер и пиши *TW* перед. f6e1️\n\n"
    "4️⃣ *Адмы — наши зайки*\n"
    "Их просьбы слушаем. Они не кусаются без повода, но если говорят — значит надо. f431\n\n"
    "Всем добра и хорошего настроения! f973"
)
